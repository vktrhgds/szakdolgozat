			...
			while($row = mysqli_fetch_assoc($cars)){
				...
				?>
					...
					<div id="bgStyle"></div>
						...
						<form method = "post" action = "carmodify_action.php" enctype = "multipart/form-data" name = "car_upload">
						...
						<div align = "center" width = "55%">
							...
							-moz-border-radius: 0 0 12 12;">
								...
								<tr>
									...
									<input type = "text" name = "autoszin" id = "input" value = "<?php echo htmlspecialchars($row['autoszin']); ?>" 
									pattern=".{1,30}" title="Minimum 1, maximum 30 karakter." required></td>
								</tr>
							</table>
						</div>
