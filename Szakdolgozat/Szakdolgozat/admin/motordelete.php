			...
			<div align = "center" width = "85%">
				...
				-moz-border-radius: 0 0 12 12;">
					<tr>
						...
						<b>Motor törlése az adatbázisból <i class="fa fa-trash "></i></font>
							...
							while($row = mysqli_fetch_assoc($getMotors)){
								echo '
									<tr height = "30px">
										...
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.htmlspecialchars($row["munkautem"]).'</td>
									...
									?>
										...
										<td>
											<form method = "get" action = "motordelete_action.php" enctype = "multipart/form-data" name = "deletemotor">
