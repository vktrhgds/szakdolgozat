...
<html>
	...
	<body>	
		<div id="bgStyle"></div>
			...
			<?php 
				$AllMessages = "SELECT * FROM adminuzenet";
				$AllMessagesQuery = mysqli_query($conn, $AllMessages);
				$countAllMessages = mysqli_num_rows($AllMessagesQuery);
				...
				?>
					...
					<div align = "center" width = "76.5%" style = "z-index: -1;" >
						<table cellspacing = "0" cellpadding = "0" id = "admintable" align = "center" width = "81.5%"
								...
								z-index: 0;">
									<tr>
										<td colspan = "2" style = "padding-bottom: 35px; padding-left: 10px; font-size: 35px; font-family: Arial;" >Bejövő üzenetek (<?php echo $countAllMessages; ?>)</td> <!-- ide a darabszám -->
									</tr>
									
									<?php while($rowMS = mysqli_fetch_assoc($AllMessagesQuery)){
									?>
									
									<tr>
										<td style = "font-size: 20px; padding: 10px; width: 90%; font-family: Arial;"><font color = "yellow"><b><?php echo htmlspecialchars($rowMS['felhasznalo_nev']); ?></b></font> |
										<font color = "black"> Tárgy: <?php echo htmlspecialchars($rowMS['targy']); ?> | </font><font color = "yellow"> <?php echo htmlspecialchars($rowMS['uzenetdatum']); ?> </font> 
										</td>
										<td style = "width: 10%;">
											<form method = "post" action = "adminmessages_delete">
												<?php echo "<input type = 'submit' class = 'delete_edit2' style = 'width: 100%;' value = 'Törlés' name = ".$rowMS['id'].">"?>
											</form>
										</td>
										</tr>
									<tr>
										<td colspan = "2" style = "font-size: 15px; padding: 10px;"> <!-- ide a komment maga -->
											<?php echo htmlspecialchars($rowMS['uzenet']); ?>
										</td>
									</tr>
									<tr>
					...
					<?php }
						...
						<div align = "center">
							<table id = "carmotortable" style = "margin-left: 0%; border-radius: 0; color: white; display: inline-block; width: 81%; padding: 20px; font-size: 25px; background: #FE2E2E; padding: 0px; padding-left: 15px;">
									<tr>
										<td colpan = "2" style = "font-size: 18px;" width = "100%"background: #56AF3E;><b>Nincsenek még bejövő üzenetek</b></td>
									</tr>
								</table>
							</div>
						';
