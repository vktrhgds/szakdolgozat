...
<html>
	...
	<body>	
		<div id="bgStyle"></div>
			...
			<form method = "POST" action = "motorupload_action.php" enctype = "multipart/form-data" name = "car_upload">
				...
				-moz-border-radius: 0 0 12 12;">
					...
					<tr>
						...
						<input type = "text" name = "kategoria" id = "input" placeholder = "pl.: Robogó"
					...
					<tr>
						...
						<input type = "text" name = "marka_tipus" id = "input" placeholder = "pl.: SR 50" 
						pattern=".{1,40}" title="Minimum 1, maximum 40 karakter." required></td>
					</tr>
					<tr>
			...
			<div align = "center" width = "55%">
				...
				-moz-border-radius: 0 0 12 12;">
					...
					<tr>
						...
						<input type = "text" name = "motorszin" id = "input"
						pattern=".{1,30}" title="Minimum 1, maximum 30 karakter." required></td>
					</tr>
				</table>
			</div>
