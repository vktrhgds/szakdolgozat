				...
				?>
					...
					<div id="bgStyle"></div>
						<div class="navbar">
						  ...
						  </div><a align = "right" title = "Automatikus kijelentkezés <?php echo $timeleft; ?> mp múlva."
						...
						<table cellspacing = "0" cellpadding = "0"  align = "center" width = "64%" > 
							<tr>
								...
								<div class="tab" id = "admintable" style = "border-radius: 0; -webkit-border-radius: 0;-moz-border-radius: 0; margin-bottom: -6px;">
									<button class="tablinks" style = "width: 33%; border-radius: 100;" onclick="openTabs(event, 'adatok1')" id="defaultOpen"><font size = "4">Motor adatai (1) <i class="fa fa-motorcycle" aria-hidden="true"></i></font></button>
									<button class="tablinks" style = "width: 33%; border-radius: 100;" onclick="openTabs(event, 'adatok2')"><font size = "4">Motor adatai (2) <i class="fa fa-motorcycle" aria-hidden="true"></i></font></button>
						...
						<form method = "post" action = "motormodify_action.php" enctype = "multipart/form-data" name = "car_upload">
							...
							-moz-border-radius: 0 0 12 12;">
								<tr>
									<td colspan = "2"height = "40px" align = "left" bgcolor = "#56AF3E" style = "padding-left: 35px; font-size: 25px;"><b>Motor módosítása az adatbázisban <i class="fa fa-edit "></i></font>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<input type = "text" name = "kategoria" id = "input" placeholder = "pl.: SUV" value = "<?php echo htmlspecialchars($row['kategoria']); ?>" 
									pattern=".{1,40}" title="Minimum 1, maximum 40 karakter." required></td>
									<td rowspan = "6" style = "padding-left: 0px;">
										<img src = "<?php echo htmlspecialchars($row['fenykep']); ?>" style = "width:100%; height: 300px; border-radius: 10px;" />
									</td>
								</tr>
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Motor márkája</br>
									<select class = "select" style = "background: rgb(96,96,96); width: 70%;" name = "motormarka_id" >
									<option><?php echo $row["motormarka_id"]; ?></option>
									  <?php
										 
										  $select_motorbrand = "SELECT * FROM motormarka;";
										  $select_motorbrand_query = mysqli_query($conn, $select_motorbrand);
										 
										  if(mysqli_num_rows($select_motorbrand_query)){
											  while($motorid = mysqli_fetch_array($select_motorbrand_query)){ ?>
											  
											  <option value = "<?php echo $motorid["id"]; ?>">
												<?php 
													echo $motorid["id"]; }}
												?>
										  </option>
								...
								<tr>
									...
									<input type = "text" name = "marka_tipus" id = "input" placeholder = "pl.: CLA 220" value = "<?php echo htmlspecialchars($row['marka_tipus']); ?>" 
									pattern=".{1,40}" title="Minimum 1, maximum 40 karakter." required></td>
								</tr>
								<tr>
						...
						<div align = "center" width = "55%">
							...
							-moz-border-radius: 0 0 12 12;">
								...
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Motor állapota</br>
									<input type = "text" name = "allapot" id = "input" value = "<?php echo htmlspecialchars($row['allapot']); ?>" 
								...
								<tr>
									...
									<input type = "text" name = "uzemanyag" id = "input" value = "<?php echo htmlspecialchars($row['uzemanyag']); ?>" 
									pattern=".{1,40}" title="Minimum 1, maximum 40 karakter." required></td>
								</tr>
								<tr>
								...
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Motor színe</br>
									<input type = "text" name = "motorszin" id = "input" value = "<?php echo htmlspecialchars($row['motorszin']); ?>" 
									pattern=".{1,40}" title="Minimum 1, maximum 30 karakter." required></td>
								</tr>
							</table>
						</div>
						</div>
						...
						<div align = "center" width = "55%">
							...
							-moz-border-radius: 0 0 12 12;">
								...
								<tr>
									<td height = "25px"  align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px; ">Munkaütem</br>
									<input type = "number" name = "munkautem" id = "input" value = "<?php echo htmlspecialchars($row['munkautem']); ?>" required></td>
								</tr>
								<tr>
