						...
						<div align = "center" width = "76.5%" style = "z-index: -1;" >
							<table cellspacing = "0" cellpadding = "0" id = "admintable" align = "center" width = "81.5%"
									...
									z-index: 0;">
										...
										<tr>
											<td style = "font-size: 20px; padding: 10px; "><font color = "yellow"><b><?php echo htmlspecialchars($rowCR['felhasznalo_nev']); ?></b></font>  értékelése:
											<font color = "yellow">
											<?php 
						...
						<div align = "center" width = "76.5%" style = "z-index: -1;" >
							<table cellspacing = "0" cellpadding = "0" id = "admintable" align = "center" width = "81.5%"
									...
									z-index: 0;">
										...
										<tr>
											<td style = "font-size: 20px; padding: 10px; "><font color = "yellow"><b><?php echo htmlspecialchars($rowMR['felhasznalo_nev']); ?></b></font>  értékelése:
											<font color = "yellow">
											<?php 
