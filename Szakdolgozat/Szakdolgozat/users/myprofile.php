					...
					<form method = "POST" action = "profile_update.php"> 
						...
						-moz-border-radius: 12;">
							...
							<tr>
								...
								<input type = "text" class = "input" name = "vnev"  value = "<?php echo htmlspecialchars($row["vezetek_nev"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Keresztnév</br>
								<input type = "text" class = "input" name = "knev"  value = "<?php echo htmlspecialchars($row["kereszt_nev"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Telefonszám</br>
								<input type = "text" class = "input" name = "telszam"  value = "<?php echo htmlspecialchars($row["telszam"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Irányítószám</br>
								<input type = "number" class = "input" name = "irszam"  value = "<?php echo htmlspecialchars($row["ir_szam"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Város</br>
								<input type = "text" class = "input" name = "varos"  value = "<?php echo htmlspecialchars($row["varos"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Utca</br>
								<input type = "text" class = "input" name = "utca"  value = "<?php echo htmlspecialchars($row["utca"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Házszám</br>
								<input type = "number" class = "input" name = "hazszam"  value = "<?php echo htmlspecialchars($row["hazszam"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Születési hely</br>
								<input type = "text" class = "input" name = "szulhely"  value = "<?php echo htmlspecialchars($row["szuletesi_hely"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Születési idő</br>
								<input type = "date" class = "input" name = "szulido"  value = "<?php echo htmlspecialchars($row["szuletesi_ido"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Anyja vezetékneve</br>
								<input type = "text" class = "input" name = "anyjavnev"  value = "<?php echo htmlspecialchars($row["anyja_vnev"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Anyja keresztneve</br>
								<input type = "text" class = "input" name = "anyjaknev"  value = "<?php echo htmlspecialchars($row["anyja_knev"]); ?>" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
							<tr>
								<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Jelszó</br>
								<input type = "password" class = "input" name = "password"  value = "" required></td> <!-- value-ba a belépett felhasználó lakcíme kerüljön -->
							</tr>
			...
			<div align = "center" style = "margin-bottom: -10px; z-index: 1;"id = "icons" >
				...
				<form method = "POST" action = "password_update.php"> <!--  action-t át kell írni! -->
					...
					-moz-border-radius: 12;">
						...
						<tr>
							<td height = "25px" colspan = "2" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Régi jelszó</br>
							<input type = "password" class = "input" name = "oldpass" required></td> 
						</tr>
						<tr>
