				...
				if (mysqli_num_rows($motors) > 0){
					while($row = mysqli_fetch_assoc($motors)){
						...
						<table id = "carmotortable" style="border:0px solid white; 
							...
							<form method = "get" action = "motor_kolcsonzes_check_data" enctype = "multipart/form-data" >
							<tr>
							...
							<tr>
								<td colspan = "3" style = "color: black; font-size: 22px; padding-bottom: 20px; padding-top: 40px;padding-left: 120px;font-family: Arial, Helvetica, sans-serif;" >Személyes adatok:</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" >
									<input type = "date" name = "kolcsonzes_kezdet_motor" style = "width: 50%; bgcolor: gray;" required />
								</td>
							</tr>
							<tr>
								...
								<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" >
									<input type = "date" name = "kolcsonzes_vege_motor" style = "width: 50%; height: 30px;" required />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan = "2" style = "padding-left: 220px; padding-bottom: 30px; padding-top: 30px;">
									<input type = "submit"  class = "viewvehicle" value = "Tovább" style = "height: 32px;width: 100%; padding: 0;" name = "<?php echo $row["motor_id2"]; ?>" >
								</td>
