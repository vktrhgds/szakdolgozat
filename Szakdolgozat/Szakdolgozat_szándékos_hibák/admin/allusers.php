			...
			<div align = "center" width = "85%">
				...
				-moz-border-radius: 0 0 12 12;">
					<tr>
						...
						<b>Regisztrált felhásználók <i class="fa fa-edit "></i></font>
						</td><td bgcolor = "#56AF3E" style = "padding-left: 10px; font-size: 25px; border-radius:0 10 10 0;
						-webkit-border-radius: 0 10 10 0;	-moz-border-radius: 0 10 10 0; border-left: 1px solid white;"><?php echo $count_user; ?> db</td>
					</tr>
					<tr>
					...
					<?php
						...
						if (mysqli_num_rows($userResult) > 0){
							...
							while($row = mysqli_fetch_assoc($userResult)){
								echo '
									<tr height = "30px">
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.$row["felhasznalo_nev"].'</td>
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.$row["vezetek_nev"].'</td>
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.$row["kereszt_nev"].'</td>
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.$row["szemelyig_szam"].'</td>
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.$row["email"].'</td>
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.$row["telszam"].' </td>
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.$row["szuletesi_hely"].' </td>
										<td height = "20px" align = "left" style =" padding: 5px 0px 0px 5px; font-size: 15px;">'.$row["szuletesi_ido"].'</td>
									';
									?>
									
										<td>
											<form method = "get" action = "viewprofile.php" enctype = "multipart/form-data" name = "viewprofile">
												<?php echo '<input type = "submit"  class = "delete_edit" value = "Profil" style = "width: 100px; padding: 0; "name = "'.$row["felhasznalo_nev"].'" >
										</td>';?>
							...
							<tr height = "30px" bgcolor = "#FE2E2E" >
								...
								<i class="fa fa-times"></i> Nincsenek regisztrált felhasználók az adatbázisban!</td>
							</tr>';
						}
