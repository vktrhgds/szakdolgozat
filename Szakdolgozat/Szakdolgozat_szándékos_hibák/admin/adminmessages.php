					...
					<div align = "center" width = "76.5%" style = "z-index: -1;" >
						<table cellspacing = "0" cellpadding = "0" id = "admintable" align = "center" width = "81.5%"
								...
								z-index: 0;">
									...
									<tr>
										<td style = "font-size: 20px; padding: 10px; width: 90%; font-family: Arial;"><font color = "yellow"><b><?php echo $rowMS['felhasznalo_nev']; ?></b></font> |
										<font color = "black"> Tárgy: <?php echo $rowMS['targy']; ?> | </font><font color = "yellow"> <?php echo $rowMS['uzenetdatum']; ?> </font> 
										</td>
										<td style = "width: 10%;">
