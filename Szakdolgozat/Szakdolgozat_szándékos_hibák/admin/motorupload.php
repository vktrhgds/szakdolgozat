...
<html>
	...
	<body>	
		<div id="bgStyle"></div>
			...
			<form method = "POST" action = "motorupload_action.php" enctype = "multipart/form-data" name = "motor_upload">
				...
				-moz-border-radius: 0 0 12 12;">
					<tr>
						<td height = "40px" align = "left" bgcolor = "#56AF3E" style = "padding-left: 35px; font-size: 25px;"><b>Motor felvétele az adatbázisba <i class="fa fa-plus "></i></font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<input type = "text" name = "kategoria" id = "input" placeholder = "pl.: Robogó" required></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<input type = "text" name = "marka_tipus" id = "input" placeholder = "pl.: SR 50" required></td>
					</tr>
					<tr>
						<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Ár (1-6 napig)</br>
						<input type = "number" name = "ar_1" id = "input" required></td>
					</tr>
					<tr>
			...
			<div align = "center" width = "55%">
				...
				-moz-border-radius: 0 0 12 12;">
					...
					<tr>
						...
						<input type = "text" name = "allapot" id = "input" required></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<input type = "text" name = "uzemanyag" id = "input" required></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<input type = "text" name = "motorszin" id = "input" required></td>
					</tr>
				</table>
			</div>
			</div>
			...
			<div align = "center" width = "55%">
				...
				-moz-border-radius: 0 0 12 12;">
					...
					<tr>
						...
						<input type = "number" name = "munkautem" id = "input" required></td>
					</tr>
					<tr>
						<td style="padding: 0px 38px 0px 30px;" colspan = "2">
							<input type = "submit" class = "input" name = "motor_upload" style = "width: 40%;" value = "Felvétel az adatbázisba" />
						</td>
					</tr>
					</div>
				</table>
