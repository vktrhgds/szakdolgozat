			...
			<form method = "POST" action = "carupload_action.php" enctype = "multipart/form-data" name = "car_upload">
				...
				-moz-border-radius: 0 0 12 12;">
					...
					<tr>
						...
						<input type = "text" name = "kategoria" id = "input" placeholder = "pl.: SUV" required></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<input type = "text" name = "marka_tipus" id = "input" placeholder = "pl.: CLA 220" required></td>
					</tr>
					<tr>
			...
			<form method = "POST" action = "carupload_action.php" enctype = "multipart/form-data" name = "car_upload">
				...
				-moz-border-radius: 0 0 12 12;">
					...
					<tr>
						...
						<input type = "text" name = "autoszin" id = "input" required></td>
					</tr>
				</table>
			</div>
			</div>
