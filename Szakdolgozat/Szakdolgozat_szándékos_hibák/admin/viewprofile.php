					...
					<div id="adatok1" class="tabcontent">
						...
						<!--<form method = "GET" action = "motormodify_action.php" enctype = "multipart/form-data" name = "car_upload">-->
							...
							-moz-border-radius: 0 0 12 12;">
								...
								<tr>
									<td width = "100%" height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Felhasználónév: <?php echo "<b>".$row['felhasznalo_nev']."</b>"; ?></td>
								</tr>
								<tr>
									<td width = "100%" height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px; ">E-mail: <?php echo $row['email']; ?></td>
								</tr>
								<tr>
									<td width = "100%" height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Telefonszám: <?php echo $row['telszam']; ?></td>
								</tr>
								<tr >
									<td width = "100%" height = "25px" align = "left" style =" padding: 5px 0px 0px 10px; font-size: 22px;color: #222222"><b>Személyes adatok</b></td>
								</tr>
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Teljes név: <?php echo $row['vezetek_nev']. " " .$row['kereszt_nev']; ?></td>
								</tr>
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Anyja neve: <?php echo $row['anyja_vnev']. " " .$row['anyja_knev']; ?></td>
								</tr>
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Személyi igazolványszám: <?php echo $row['szemelyig_szam']; ?></td>
								</tr>
								<tr>
									<td width = "100%" height = "25px" align = "left" style =" padding: 5px 0px 0px 10px; font-size: 22px;color: #222222"><b>Lakcím adatok</b></td>
								</tr>
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Lakcím: <?php echo $row['ir_szam']." ".$row['varos'].", ". $row['utca']." ".$row['hazszam']."."; ?></td>
								</tr>
								<tr >
									<td width = "100%" height = "25px" align = "left" style =" padding: 5px 0px 0px 10px; font-size: 22px;color: #222222"><b>Születési adatok</b></td>
								</tr>
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Születési hely: <?php echo $row['szuletesi_hely']; ?></td>
								</tr>
								<tr>
									<td height = "25px" align = "left" style =" padding: 5px 0px 0px 30px; font-size: 22px;">Születési idő: <?php echo $row['szuletesi_ido']; ?></td>
								</tr>
							</table>
						</div>
					</div>
					...
					<div id="adatok2" class="tabcontent">
						<div align = "center" width = "76.5%" style = "z-index: -1;" >
							<table cellspacing = "0" cellpadding = "0" id = "admintable" align = "center" width = "81.5%"
									...
									z-index: 0;">
										<tr>
											<td style = "padding-bottom: 35px; padding-left: 10px; font-size: 35px;" ><?php echo $row['felhasznalo_nev']; ?> értékelései <b>(<?php echo $countPersonalCarRatings; ?>)</b></td> <!-- ide a darabszám -->
										</tr>
										...
										<tr>
											<td style = "font-size: 20px; padding: 10px; "><font color = "yellow"><b><?php echo $row['felhasznalo_nev']; ?></b></font>  értékelése:
											<font color = "yellow"><?php echo $rowCR['ertekeles']; ?>/5 </font><font color = "white"><?php echo $rowCR['datum']; ?> dátummal </font> 
					...
					<div id="adatok3" class="tabcontent">
						<div align = "center" width = "76.5%" style = "z-index: -1;" >
							<table cellspacing = "0" cellpadding = "0" id = "admintable" align = "center" width = "81.5%"
									...
									z-index: 0;">
										<tr>
											<td style = "padding-bottom: 35px; padding-left: 10px; font-size: 35px;" ><?php echo $row['felhasznalo_nev']; ?> értékelései <b>(<?php echo $countPersonalMotorRatings; ?>)</b></td> <!-- ide a darabszám -->
										</tr>
										...
										<tr>
											<td style = "font-size: 20px; padding: 10px; "><font color = "yellow"><b><?php echo $row['felhasznalo_nev']; ?></b></font>  értékelése:
											<font color = "yellow"><?php echo $rowMR['ertekeles']; ?>/5 </font><font color = "white"><?php echo $rowMR['datum']; ?> dátummal </font> 
