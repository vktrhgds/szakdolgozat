...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2018. Máj 09. 09:17
...
--
-- Adatbázis: `jarmuadatbazis_hibas`
--
...
(24, '../pictures/jarmuadatbazis_kepek/audi_a5cabrio.jpg', 'Cabrio', 'Audi', 19990, 16890, 13490, 'A5 ', 2013, 'Alig használt', 39910, 4, 'Dízel', 2000, 178, 'Szürke', 1398, 1877, 60, 6.8, 238, 6.9, 95, 'dHbT7rhMOaNfJzN44UFjiar5F1c8JWPCdeYRGci7xAGMnn2qqGKYXZBkhMgblOqJ941VMi6jxJNp6gQBSjtn7rey0ygMPaMgzyVM'),
...
('CMRentadmin', 'CMRentadmin1', 'Admin', 'Admin', 'NO-DATA', 'NO-DATA', 'NO-DATA', 'admin@admin.admin', '+36305457843', 0, 'NO-DATA', 'NO-DATA', 0, 'NO-DATA', '2018-02-01', 1, 'NO-DATA'),
('email_proba', 'proba1234', 'Lengyel', 'József', '21011391', 'Németh', 'Viola', 'emailproba123456@gmail.com', '+36 30 1234567', 3242, 'Budapest', 'Alma', 12, 'Debrecen', '1988-04-25', 1, 'BMW');
...
(6, '../pictures/jarmuadatbazis_kepek/keeway_matrix50.jpg', 'Robogó', 'Keeway', 5990, 4190, 3090, 'Matrix 50', 2011, 'Alig használt', 1233, 'Benzin', 50, 5, 'Kék', 106, 219, 10, 3.5, 58, 0, 4, 'LyBXwMZGfEX5jSU6V6BhFE6jkhw2NmhPe2PnfPVPq6PyzXKmV7T0YrmEVlugEDdDq7G9gXTrIs4NUMkAGDWgkTcvm6xgkFv5FWiI'),
