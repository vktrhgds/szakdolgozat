			...
			<?php
				...
				if (mysqli_num_rows($cars) > 0){
					while($row = mysqli_fetch_assoc($cars)){
						...
						$rent_start = $_GET['kolcsonzes_kezdet_auto'];	
						$rent_end = $_GET['kolcsonzes_vege_auto'];
						...
						<table id = "carmotortable" style="border:0px solid white; 
							...
							<form method = "GET" action = "auto_kolcsonzes_action" enctype = "multipart/form-data" >
							<tr>
							...
							<tr>
								...
								<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $row['autoszin']; ?> </td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $row['oktanszam']; ?> </td>
							</tr>
							<tr>
								...
								<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $row['szallithato_szemelyek']; ?> személy</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan = "3" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-top: 20px;padding-left: 220px;font-family: Arial, Helvetica, sans-serif;" >
									...
									<input type = "hidden" name = "startdatehidden" value = "<?php echo $rent_start; ?>">
									<input type = "hidden" name = "enddatehidden" value = "<?php echo $rent_end; ?>">
									<input type = "hidden" name = "dailypricehidden" value = "<?php echo $daily_price; ?>">
									<input type = "hidden" name = "wholepricehidden" value = "<?php echo $whole_price; ?>">
								</td>
							</tr>
							<tr>
