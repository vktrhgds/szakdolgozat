			...
			<form method = "get" action = "usercarsearch.php" enctype = "multipart/form-data" name = "search_simple">
				...
				<?php
					if(isset($_GET['search_extended_button'])){
						...
						$category = $_GET['select_categ'];
						$cartype = $_GET['select_cartype'];
						$fuel = $_GET['select_fuel'];
						$enginecap = $_GET['select_enginecap'];
						$carcolor = $_GET['select_carcolor'];
