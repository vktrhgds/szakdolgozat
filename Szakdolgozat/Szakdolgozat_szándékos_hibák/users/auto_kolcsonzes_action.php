				...
				if (mysqli_num_rows($cars) > 0){
					while($row = mysqli_fetch_assoc($cars)){
						if(isset($_GET[$row['id']])){
							...
							$login_session1 = $_GET['userhidden'];
							$rent_start_car = $_GET['startdatehidden'];
							$rent_end_car = $_GET['enddatehidden'];
							$daily_price_car = $_GET['dailypricehidden'];
							$whole_price_car = $_GET['wholepricehidden'];
							...
							VALUES('".$login_session1."','".$row['id']."', '".$rent_start_car."', '".$rent_end_car."', '".$daily_price_car."', '".$whole_price_car."');";
...
Üdvözlettel, CMRent	";
							...
							<table id = "carmotortable" style="border:0px solid white; 
								...
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['felhasznalo_nev']; ?></td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['vezetek_nev'].' '.$user_data['kereszt_nev']; ?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['email']; ?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['telszam']; ?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['anyja_vnev'].' '.$user_data['anyja_knev']; ?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['ir_szam'].' '.$user_data['varos'].', '.$user_data['utca'].' '.$user_data['hazszam'].'.';?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['szuletesi_hely']; ?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['szuletesi_ido']; ?> </td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $row['automarka_id'].' '.$row['marka_tipus']; ?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['mettol']; ?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['meddig']; ?> </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['ar_naponta']; ?> HUF </td>
								</tr>
								<tr>
									...
									<td colspan = "2" style = "border-bottom: 1px solid rgb(209, 209, 209); color: black; font-size: 18px; padding: 0px; text-align: left; padding-left: 0px;font-family: Arial, Helvetica, sans-serif;" ><?php echo $user_data['ar_osszesen']; ?> HUF</td>
								</tr>
								<tr>
