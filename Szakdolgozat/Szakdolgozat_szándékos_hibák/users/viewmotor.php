					...
					<form method = "get" action = "viewmotor.php" enctype = "multipart/form-data" name = "search_simple">
						...
						<tr>
							...
							<td colspan = "2"style = "text-align: left; padding-top: 10px;" width = "15%">
								<?php echo $row['motormarka_id']." ".$row['marka_tipus'].", ".$row['kategoria']; ?>
							</td>
						</tr>
						</tr>
					...
					<div align = "center">
							...
							style = " border-radius: 0;z-index: 0; display: inline-block; width: 69.5%; margin-left: 20%; border-bottom: 2px solid gray; background: #E6E6E6; color: black;"
								<tr>
									...
									<td style = "text-align: left; padding: right: 10px;" width = "15%"><b><?php echo $row['motormarka_id']; ?></b></td>
								...
								<tr>
									...
									<td style = "text-align: left; padding-right: 10px;"><b><?php echo $row['km_ora_allasa']; ?> km</b></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td style = "text-align: left; padding-right: 10px;"><b><?php echo $row['motorszin']; ?> </b></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td style = "text-align: left; padding-right: 10px;"><b><?php echo $row['munkautem']; ?> </b></td>
								</tr>
								<tr>
							...
							if ($countmotorrates > 0){
								...
								<div align = "center">
									...
									margin-left: 20%; border-bottom: 6px solid #Dadada; background: white; color: black;" >
										<tr>
											<td>
												Értékelések (<?php echo $countmotorrates; ?>)
											</td>
										</tr>
									</table>
								</div>
								...
								while($row = mysqli_fetch_assoc($motorrate_query)){
									...
									<div align = "center">
										...
										<tr>
											...
											?></font><font color = "black" style = "font-size: 11px;"> <?php echo $row['datum']; ?></font> 
